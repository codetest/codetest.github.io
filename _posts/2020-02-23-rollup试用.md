...
```
显然可以去掉一些空格空行，这里可以使用[rollup-plugin-uglify](https://www.npmjs.com/package/rollup-plugin-uglify)进行minify和混淆。具体的使用方法如下。mangle是做混淆用的。具体可以参见[rolluptest v2](https://github.com/codetest/rolluptest/tree/v2)
```javascript
